...
export default (props) =>
    ...
    <div className="chord">
        ...
        <button onClick={(e) => props.setChord(e.target.value) & props.setSelectedNote(props.note)}  value="M7M">M7M</button>
        <button onClick={(e) => props.setChord(e.target.value) & props.setSelectedNote(props.note)}  value="M7">M7</button>
        ...
        <button onClick={(e) => props.setChord(e.target.value) & props.setSelectedNote(props.note)}  value="M9">M9</button>
