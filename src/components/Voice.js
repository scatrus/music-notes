...
{/* ----------------------------------------------------------------- */}
        ...
        <div className="resultVoices">
            <div>
            {/* <button onClick={()=>setN1(n1 + 1)}>#</button> */}
            {Notas[n1 + 2].button}
            {/* <button onClick={()=>setN1(n1 - 1)}>b</button> */}
            </div>

            <div>
            {/* <button onClick={()=>setN2(n2 + 1)}>#</button> */}
            {Notas[n2 + 2].button}
            {/* <button onClick={()=>setN2(n2 - 1)}>b</button> */}
            </div>

            <div>
            {/* <button onClick={()=>setN3(n3 + 1)}>#</button> */}
            {Notas[n3 + 2].button}
            {/* <button onClick={()=>setN3(n3 - 1)}>b</button> */}
            </div>

            <div>
            {/* <button onClick={()=>setN4(n4 + 1)}>#</button> */}
            {Notas[n4 + 2].button}
            {/* <button onClick={()=>setN4(n4 - 1)}>b</button> */}
            </div>

            <div>
            {/* <button onClick={()=>setN5(n5 + 1)}>#</button> */}
            {Notas[n5 + 2].button}
            {/* <button onClick={()=>setN5(n5 - 1)}>b</button> */}
            </div>
